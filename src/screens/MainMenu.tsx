...
export function MainMenu({ actions }: MainMenuProps) {
  return (
    <>
      <header>
          <div><div className="meta">compact arcade game called Neon Courier PRD</div><h1>Main Menu</h1><p>Start, resume, restart, and any task-requested mode or difficulty actions.</p></div>
