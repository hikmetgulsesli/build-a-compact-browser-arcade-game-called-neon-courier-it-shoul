...
export function PauseOverlay({ actions }: PauseOverlayProps) {
  return (
    <>
      <header>
          <div><div className="meta">compact arcade game called Neon Courier PRD</div><h1>Pause Overlay</h1><p>Paused state with resume, restart, and return-to-menu actions.</p></div>
