...
export function GameOver({ actions }: GameOverProps) {
  return (
    <>
      <header>
          <div><div className="meta">compact arcade game called Neon Courier PRD</div><h1>Game Over</h1><p>Final score/progress summary, replay, and return-to-menu actions.</p></div>
