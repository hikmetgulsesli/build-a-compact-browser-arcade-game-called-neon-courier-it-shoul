...
export function ControlsHelp({ actions }: ControlsHelpProps) {
  return (
    <>
      <header>
          <div><div className="meta">compact arcade game called Neon Courier PRD</div><h1>Controls Help</h1><p>Task-requested keyboard/touch controls and concise rules.</p></div>
